<div class="modal fade" id="createProjectModal" role="dialog" tabindex="-1" aria-labelledby="label-modal"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="frmCreateProject" method="POST" enctype="multipart/form-data" autocomplete="off">
                    <div class="form-group">
                        ...
                        <input class="form-control" name="title" required type="text" minlength="4" maxlength="10"
                            id="create_title" placeholder="Title">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="create_desc_text" name="description" rows="4" maxlength="50"
            ...
            <div class="modal-footer">
                <input class="btn btn-secondary btn-sm" id="btn-reset-create" type="reset" onclick="closeCreateModal();"
                    value="Cancel">
