<div class="modal fade" id="editProjectModal" role="dialog" tabindex="-1" aria-labelledby="label-modal"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="frmEditProject" method="POST" enctype="multipart/form-data" autocomplete="off" novalidate>
                    @csrf
                    <div class="form-group">
                        <label for="edit_title">Title*</label>
                        <input class="form-control" name="title" required type="text" minlength="4" maxlength="30"
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="edit_desc_text" name="description" rows="4" maxlength="50"
            ...
            <div class="container" id="alert-area-edit"></div>
            <div class="modal-footer">
                <input class="btn btn-secondary btn-sm" id="btn-reset-edit" type="reset" onclick="closeEditModal();"
                    value="Cancel">
