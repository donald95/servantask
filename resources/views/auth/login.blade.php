...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Login Donald') }}</div>
...
<body>
    <div class="align-icon">
        <a href="{{ route('welcome') }}">
            <img src="{{ asset('img/angry-dog.svg') }}" alt="servant" style="width: 70px;">
        </a>
    </div>
    <div class="container pb-4">
        <form class="" name='login' action="{{ route('login') }}"" method='POST' enctype=" multipart/form-data">
            @csrf
                    ...
                    <td>
                        <div class="input-group mb-3 w-100">
                            ...
                            <input id="email" name="email" type="email"
                                ...
                                placeholder="E-mail" aria-label="Recipient's email" value="{{ old('email') }}" required
                    ...
                    <td>
                        <div class="input-group mb-3 w-100">
                            ...
                            <input id="password" name="password" type="password"
                                ...
                                placeholder="Password" aria-label="Recipient's username" required
